            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 2:
                        ...
                        m3 = new Medico("GI0002", "Ana Paz", "12345678B", Especialidad.GINECOLOGIA);
                        m4 = new Medico("TR0003", "Pedro", "12345678C", Especialidad.TRAUMATOLOGIA);
                        medicosCreados = true;
                        break;
                    case 3:
                        ...
                        if (pacientesCreados && medicosCreados) {
                            ...
                            v2 = new Visita("2", LocalDate.of(2022, Month.FEBRUARY, 10), p1, m1, Visita.REVISION, "Descripcion2", "Tratamiento2", Utilidades.precioVisita(Visita.REVISION, Especialidad.GINECOLOGIA, Visita.PRECIO_MINIMO));
                            v3 = new Visita("3", LocalDate.of(2022, Month.FEBRUARY, 10), p2, m2, Visita.RECETAS, "Descripcion3", "Tratamiento3", Utilidades.precioVisita(Visita.RECETAS, Especialidad.TRAUMATOLOGIA, Visita.PRECIO_MINIMO));
                            v4 = new Visita("4", LocalDate.of(2022, Month.FEBRUARY, 11), p3, m3, Visita.URGENCIAS, "Descripcion4", "Tratamiento5", Utilidades.precioVisita(Visita.URGENCIAS, Especialidad.TRAUMATOLOGIA, Visita.PRECIO_MINIMO));
